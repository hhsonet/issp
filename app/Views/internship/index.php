        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft">
            ...
            <div class="mt-6 overflow-x-auto">
                <table class="min-w-full text-left text-sm">
                    <thead><tr class="text-xs uppercase text-slate-500"><th class="py-3 pr-4">Application</th><th class="py-3 pr-4">Round</th><th class="py-3 pr-4">Organization</th><th class="py-3 pr-4">Status</th><th class="py-3 pr-4">Submitted</th><th class="py-3 pr-4"></th></tr></thead>
                    <tbody>
                    <?php if (! $applications): ?>
                        <tr><td colspan="6" class="py-10"><?= view('components/empty_state', ['title' => 'No applications yet.', 'message' => 'Start a new application when an open round is available.', 'actionUrl' => site_url('apply'), 'actionLabel' => 'Apply Now']) ?></td></tr>
                    <?php else: foreach ($applications as $application): ?>
                        <tr class="border-t border-slate-200">
                            ...
                            <td class="py-4 pr-4"><?= esc((string) ($application['round_title'] ?? ('Round ' . ($application['round_code'] ?? '')))) ?></td>
